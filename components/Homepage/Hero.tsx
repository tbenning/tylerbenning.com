...
export default function Hero() {
  return (
    <section className="relative px-8 pb-6 mb-0 overflow-hidden border border-t-0 md:px-12 md:pb-12 lg:overflow-visible lg:pl-12 lg:pr-0 rounded-b-3xl grid grid-cols-1 lg:grid-cols-2 lg:gap-4 lg:mb-0 lg:-mx-12">
      ...
      <motion.img
        ...
        className="absolute bg-white border rounded-lg cursor-pointer w-60 left-1/3 -top-60 md:w-80 lg:left-auto lg:right-32 lg:top-20 lg:w-auto"
      />
    </section>
  )
}
