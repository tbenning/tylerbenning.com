      ...
      {projects.map((project) => (
        <li key={project.id} className="pb-6 border-b-2 border-dotted">
          <Link
            ...
            className="relative inline-block w-full h-48 pt-8 pl-8 mb-4 overflow-hidden bg-gray-100 rounded-lg transition duration-300 ease-in-out hover:shadow-lg hover:scale-105"
          >
          ...
          <Link href={`/project/${project.slug}`} className="mt-3 btn-light">
            Read More
          </Link>
        </li>
      ))}
